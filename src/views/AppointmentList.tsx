      ...
      <div className="grid grid-cols-3 gap-3 sm:gap-4 mb-6">
        <div className="bg-card rounded-xl card-shadow p-3 sm:p-5 flex flex-col items-center text-center gap-2">
          ...
          <div className="flex flex-col flex-grow justify-center">
            <div className="text-[10px] sm:text-sm text-muted-foreground font-medium leading-tight">Today</div>
            <div className="text-lg sm:text-2xl font-bold mt-1">{todayCount}</div>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl card-shadow p-3 sm:p-5 flex flex-col items-center text-center gap-2">
          ...
          <div className="flex flex-col flex-grow justify-center">
            <div className="text-[10px] sm:text-sm text-muted-foreground font-medium leading-tight">Upcoming</div>
            <div className="text-lg sm:text-2xl font-bold mt-1">{upcomingCount}</div>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl card-shadow p-3 sm:p-5 flex flex-col items-center text-center gap-2">
          ...
          <div className="flex flex-col flex-grow justify-center">
            <div className="text-[10px] sm:text-sm text-muted-foreground font-medium leading-tight">Completed</div>
            <div className="text-lg sm:text-2xl font-bold mt-1">{completedCount}</div>
          </div>
        </div>
      </div>
