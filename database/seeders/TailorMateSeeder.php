    ...
    public function run(): void
    {
        ...
        $staff = collect([
            Staff::updateOrCreate(
                ['email' => 'michael.t@tailormate.local'],
                ['name' => 'Michael T.', 'phone' => '9990001111', 'role' => 'Tailor'],
            ),
            Staff::updateOrCreate(
                ['email' => 'sarah.k@tailormate.local'],
                ['name' => 'Sarah K.', 'phone' => '9990002222', 'role' => 'Tailor'],
            ),
            Staff::updateOrCreate(
                ['email' => 'admin.staff@tailormate.local'],
                ['name' => 'Admin', 'phone' => '9990003333', 'role' => 'Admin'],
            ),
        ]);
